...
outputEnTeteHTML("D&eacute;connexion r&eacute;ussie");
?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Information
                    <small>D&eacute;connexion r&eacute;ussi</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="?action=accueil">Home</a>
                    </li>
                    <li class="active">D&eacute;connexion r&eacute;ussi</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="jumbotron">
                    ...
                    <p style="clear:both">
                        Tu es maintenant d&eacute;connect&eacute; !
                    </p>
                </div>
            </div>
