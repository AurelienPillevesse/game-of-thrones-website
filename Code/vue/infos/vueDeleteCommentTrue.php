...
outputEnTeteHTML("Suppression valide");
?>

<meta http-equiv="refresh" content="1; URL=?action=get-all"/>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Information
                    <small>Suppression valide</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="?action=accueil">Home</a>
                    </li>
                    <li class="active">Suppression valide</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="jumbotron">
                    ...
                    <p style="clear:both">
                        Le commentaire a &eacute;t&eacute; supprim&eacute; !
                    </p>
                </div>
            </div>
