    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <br/>
                <?php if($modeleArticle->getData()->getNbImage() == 0) { ?>
                <a class="btn btn-primary" href="?action=ajouterImage&idArticlePersonnage=<?php echo $modeleArticle->getData()->getId(); ?>">Ajouter image <i class="fa fa-angle-right"></i></a>
                <?php } else { ?>
                <a class="btn btn-primary" href="?action=deleteImage&idArticlePersonnage=<?php echo $modeleArticle->getData()->getId(); ?>">Supprimer image <i class="fa fa-angle-right"></i></a>
                <?php } ?>
                <hr>
                <?php
                ...
                <a class="btn btn-primary" href="?action=deleteComment&id=<?php echo $comment->getId(); ?>">Supprimer <i class="fa fa-angle-right"></i></a>
                <hr>
                ...
                <form action="?action=putComment" name="saisieCommentaire" role="form" class="form-horizontal" method="POST" accept-charset="utf-8">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="hidden" name="idArticle" value="<?php echo $value; ?>" />
                    </div>
                    </div> 
