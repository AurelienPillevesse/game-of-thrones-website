    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <a class="btn btn-primary" href="?action=modifyArticle&id=<?php echo $article->getId(); ?>">Modifier <i class="fa fa-angle-right"></i></a>
                <a class="btn btn-primary" href="?action=deleteArticle&id=<?php echo $article->getId(); ?>">Supprimer <i class="fa fa-angle-right"></i></a>
                <hr>
